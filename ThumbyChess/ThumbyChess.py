...
def picker(xdraw=0, ydraw=0, lastpos = False):
    ...
    while (thumby.buttonA.justPressed() == False and thumby.buttonB.justPressed() == False):
        ...
        thumby.display.drawText(x1 + y1, xdraw, ydraw, 1)
...
def pick_move():    
    ...
    while choice2 == False:
        if choice1 == False: choice1 = picker(0, choicedraw)
        if choice1: thumby.display.drawText(">", 18, choicedraw, 1)
        if choice1: choice2 = picker(30, choicedraw ,choice1)
        if choice2 == False: 
            choice1 = False
            thumby.display.update()
...
def main():
    ...
    while True:
        ...
        thumby.display.fill(0)
        thumby.display.drawText("My Move:", 0, 0, 1)
        thumby.display.drawText(mymove, 0, 10, 1)
        thumby.display.drawText("Your Move?", 0, 22, 1)
        thumby.display.update()
        hist.append(hist[-1].move(move))
